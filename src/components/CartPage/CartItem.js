...
import { FaTrash, FaChevronCircleUp, FaChevronCircleDown, FaCreativeCommonsNcJp } from 'react-icons/fa'
    ...
    return (
        <div className="row mt-5 mt-lg-0 text-capitalize text-center align-items-center">
            ...
            <div className="col-10 mx-auto col-lg-2 pb-2">
                <img src={image} width='60' className='img-fluid' alt="product image" />
            </div>
            {/* end image */}
            {/* title */}
            <div className="col-10 mx-auto col-lg-2 pb-2">
